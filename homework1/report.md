...
### 不同排序最糟情況運行時間
| 測試案例 | 輸入參數 $n$ | Insertion Sort(5次平均) | Merge Sort(5次平均) |Heap Sort(20組取最大) | Quick Sort(20組取最大) |
|----------|--------------|----------|----------|----------|----------|
| 測試一   | $n = 500$      | 0.0004        | 0.0002       |0.001        |0.00020  |
| 測試二   | $n = 1000$      | 0.001        | 0.001      |0.001        |0.00045   |
| 測試三   | $n = 2000$      | 0.0048        | 0.0022        |0.003       |0.00100        |
| 測試四   | $n = 3000$      | 0.01       | 0.0026     |0.004        |0.00160     |
| 測試五   | $n = 4000$     | 0.0166 |0.003  | 0.009  |   0.00230     |
| 測試六   | $n = 5000$     |  0.0274|0.0038 |  0.011    |0.00300      |
